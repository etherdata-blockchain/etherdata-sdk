...
suspend fun getStorageAt(address:Any, position:Any, tag:String): Any{
    ...
    val response: JsonRpcResponse<Any> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getStorageAt", params = listOf(address, position, tag), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionCount(address:Any, state:String): Long{
    ...
    val response: JsonRpcResponse<Long> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getTransactionCount", params = listOf(address, state), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionCountByHash(data:String, qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getTransactionCountByHash", params = listOf(data, qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockTransactionCountByHash(data:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getBlockTransactionCountByHash", params = listOf(data), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockTransactionCountByNumber(qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getBlockTransactionCountByNumber", params = listOf(qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleCountByBlockHash(data:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getUncleCountByBlockHash", params = listOf(data), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleCountByBlockNumber(qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getUncleCountByBlockNumber", params = listOf(qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun estimateGas(obj:Obj, qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_estimateGas", params = listOf(obj, qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockByNumber(qUANTITY_TAG:String, bool:Boolean): GetBlockByNumberResponseObj{
    ...
    val response: JsonRpcResponse<GetBlockByNumberResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getBlockByNumber", params = listOf(qUANTITY_TAG, bool), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionByHashAndIndex(data:String, quantity:String): GetTransactionByHashAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetTransactionByHashAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getTransactionByHashAndIndex", params = listOf(data, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionByBlockNumberAndIndex(qUANTITY_TAG:String, quantity:String): GetTransactionByBlockNumberAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetTransactionByBlockNumberAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getTransactionByBlockNumberAndIndex", params = listOf(qUANTITY_TAG, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleByBlockHashAndIndex(data:String, quantity:String): GetUncleByBlockHashAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetUncleByBlockHashAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getUncleByBlockHashAndIndex", params = listOf(data, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleByBlockNumberAndIndex(qUANTITY_TAG:String, quantity:String): GetUncleByBlockNumberAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetUncleByBlockNumberAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_getUncleByBlockNumberAndIndex", params = listOf(qUANTITY_TAG, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun newPendingTransactionFilter(): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "eth_newPendingTransactionFilter", params = listOf(), jsonrpc = "2.0", id = 1 )
    }
    return response.result
