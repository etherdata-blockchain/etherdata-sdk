...
data class Obj (val from:String,val to:String,val gas:String,val gasPrice:String,val value:String,val data:String,val nonce:String)

data class GetBlockByHashResponseObj (val number:String,val hash:String,val parnetHash:String,val nonce:String,val sha3Uncles:String,val logsBloom:String,val transactionsRoot:String,val miner:String,val difficulty:String,val totalDifficulty:String,val extraData:String,val size:String,val gasLimit:String,val gasUsed:String,val timestamp:String,val transaction:List<String>,val uncles:List<String>)

data class GetBlockByNumberResponseObj (val number:String,val hash:String,val parnetHash:String,val nonce:String,val sha3Uncles:String,val logsBloom:String,val transactionsRoot:String,val miner:String,val difficulty:String,val totalDifficulty:String,val extraData:String,val size:String,val gasLimit:String,val gasUsed:String,val timestamp:String,val transaction:List<String>,val uncles:List<String>)

data class GetTransactionByHashResponseObj (val blockHash:String,val blockNumber:String,val from:String,val gas:String,val gasParice:String,val hash:String,val input:String,val nonce:String,val to:String,val transactionIndex:String,val value:String,val v:String,val r:String,val s:String)
...
data class GetTransactionReceiptResponseObj (val transactionHash:String,val transactionIndex:String,val blockHash:String,val blockNumber:String,val from:String,val to:String,val cumulativeGasUsed:String,val gasUsed:String,val contractAddress:String,val logs:List<String>,val logsBloom:String,val root:String,val status:String)
...
data class Array (val removed:Boolean,val logIndex:String,val transactionIndex:String,val transactionHash:String,val blockHash:String,val blockNumber:String,val address:String,val data:String,val topics:List<String>)
...
suspend fun getStorageAt(address:Any, position:Any, tag:String): Any{
    ...
    val response: JsonRpcResponse<Any> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getStorageAt", params = listOf(address, position, tag), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionCount(address:Any, state:String): Long{
    ...
    val response: JsonRpcResponse<Long> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getTransactionCount", params = listOf(address, state), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionCountByHash(data:String, qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getTransactionCountByHash", params = listOf(data, qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockTransactionCountByHash(data:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getBlockTransactionCountByHash", params = listOf(data), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockTransactionCountByNumber(qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getBlockTransactionCountByNumber", params = listOf(qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleCountByBlockHash(data:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getUncleCountByBlockHash", params = listOf(data), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleCountByBlockNumber(qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getUncleCountByBlockNumber", params = listOf(qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun estimateGas(obj:Obj, qUANTITY_TAG:String): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_estimateGas", params = listOf(obj, qUANTITY_TAG), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getBlockByNumber(qUANTITY_TAG:String, bool:Boolean): GetBlockByNumberResponseObj{
    ...
    val response: JsonRpcResponse<GetBlockByNumberResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getBlockByNumber", params = listOf(qUANTITY_TAG, bool), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getTransactionByHashAndIndex(data:String, quantity:String): GetTransactionByHashAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetTransactionByHashAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getTransactionByHashAndIndex", params = listOf(data, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
* @return obj See etd_getTransactionByHash
*/
suspend fun getTransactionByBlockNumberAndIndex(qUANTITY_TAG:String, quantity:String): GetTransactionByBlockNumberAndIndexResponseObj{
    
    val response: JsonRpcResponse<GetTransactionByBlockNumberAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getTransactionByBlockNumberAndIndex", params = listOf(qUANTITY_TAG, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun getUncleByBlockHashAndIndex(data:String, quantity:String): GetUncleByBlockHashAndIndexResponseObj{
    ...
    val response: JsonRpcResponse<GetUncleByBlockHashAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getUncleByBlockHashAndIndex", params = listOf(data, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
* @return obj See etd_getTransactionByHash Note - An uncle doesn’t contain individual transactions.
*/
suspend fun getUncleByBlockNumberAndIndex(qUANTITY_TAG:String, quantity:String): GetUncleByBlockNumberAndIndexResponseObj{
    
    val response: JsonRpcResponse<GetUncleByBlockNumberAndIndexResponseObj> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_getUncleByBlockNumberAndIndex", params = listOf(qUANTITY_TAG, quantity), jsonrpc = "2.0", id = 1 )
    }
    return response.result
...
suspend fun newPendingTransactionFilter(): String{
    ...
    val response: JsonRpcResponse<String> = client.post(url){
        contentType(ContentType.Application.Json)
        body = JsonRpcRequest(method =  "etd_newPendingTransactionFilter", params = listOf(), jsonrpc = "2.0", id = 1 )
    }
    return response.result
