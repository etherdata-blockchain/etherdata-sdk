...
data class Transaction (val blockHash:String,val blockNumber:Long,val from:String,val gas:String,val gasPrice:String,val hash:String,val input:String,val nonce:String,val to:String,val transactionIndex:Long,val value:String)
...
data class ContentResponseTransactionObject (val pendingTransactions:List<PendingTransactions>,val queuedTransactions:List<QueuedTransactions>)

data class TransactionArray (val transaction:String)

data class InspectResponseTransactionObject (val pendingTransactions:List<PendingTransactions>,val queuedTransactions:List<QueuedTransactions>)
