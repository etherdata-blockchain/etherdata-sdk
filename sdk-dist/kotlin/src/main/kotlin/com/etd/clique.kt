...
data class GetSnapshotResponseSnapshot (val hash:String,val number:Long,val recents:GetSnapshotResponseRecents,val signers:GetSnapshotResponseSigners)

data class StatusResponseSealerActivity (val signerAddresses:String,val numBlocksSigned:Long)

data class StatusResponse (val inturnPercent:Long, val sealerActivity:StatusResponseSealerActivity, val numBlocks:Long, )
